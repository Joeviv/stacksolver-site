            ...
            <div className="overflow-x-auto pb-4 custom-scrollbar">
                <div className="min-w-[700px]">
                    ...
                    <div className="flex border-b border-zinc-200 dark:border-zinc-800 pb-4 mb-4">
                        <div className="w-64 flex-shrink-0 font-bold text-zinc-500 dark:text-zinc-500 text-xs uppercase tracking-wider">Fase & Fechas</div>
                        <div className="flex-1 relative h-6">
                            {/* Simple Timeline Markers */}
                            <div className="absolute left-0 text-[10px] text-zinc-400 dark:text-zinc-600 border-l border-zinc-200 dark:border-zinc-800 pl-1">Inicio</div>
                            <div className="absolute right-0 text-[10px] text-zinc-400 dark:text-zinc-600 border-r border-zinc-200 dark:border-zinc-800 pr-1">Fin Proyecto</div>
                            <div className="absolute left-1/2 text-[10px] text-zinc-400 dark:text-zinc-600 border-l border-zinc-200 dark:border-zinc-800 pl-1 transform -translate-x-1/2">Mitad</div>
                        </div>
                    </div>
                                    ...
                                    <div className="w-64 flex-shrink-0 pr-6">
                                        ...
                                        <div className="flex flex-col gap-2">
                                            <div className="flex items-center gap-2">
                                                <span className="text-[10px] text-zinc-500 dark:text-zinc-600 w-8">Inicio:</span>
                                                <input
                                                    type="date"
                                            ...
                                            <div className="flex items-center gap-2">
                                                <span className="text-[10px] text-zinc-500 dark:text-zinc-600 w-8">Fin:</span>
                                                <input
                                                    type="date"
                                                    value={phase.endDate}
